...
(will be replaced by a color editor).
        ...
        model CoordinateSystem "Visualizing an orthogonal coordinate system of three axes"
          ...
          parameter SI.Length scaledLabel = PlanarMechanics.Types.Defaults.FrameLabelHeightFraction * axisDiameter annotation (
            Dialog(group = "Axes labels", enable = axisShowLabels));
        protected
          outer .Praktikum10.PlanarMechanics.PlanarWorld planarWorld;
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
  ...
  Praktikum10.Differential differential annotation (Placement(visible=true,
          transformation(
          origin={62,30},
          extent={{-10,-10},{10,10}},
          rotation=90)));
  ...
  model Chassis2D
    ...
    Praktikum10.PlanarMechanics.VehicleComponents.Wheels.DryFrictionWheelJoint dryFrictionWheelJoint1(
      radius=wheelRadius,
      r={1,0},
      N=(carMass/4 + 19)*9.81,
      vAdhesion=0.01,
    ...
    Praktikum10.PlanarMechanics.Parts.FixedTranslation fixedTranslation1(r={0,-
          trackWidth/2}) annotation (Placement(visible=true, transformation(
          origin={48,20},
          extent={{10,-10},{-10,10}},
          rotation=0)));
    Praktikum10.PlanarMechanics.Parts.FixedTranslation fixedTranslation3(r={0,-
          trackWidth/2}) annotation (Placement(visible=true, transformation(
          origin={46,-60},
          extent={{10,-10},{-10,10}},
          rotation=0)));
    Praktikum10.PlanarMechanics.Parts.Body body1(m=19, I=0.653) annotation (
        Placement(visible=true, transformation(
          origin={-20,42},
          extent={{-8,-8},{8,8}},
          rotation=90)));
    Praktikum10.PlanarMechanics.Parts.Body body3(
      I=0.653,
      animate=true,
      enableGravity=true,
    ...
    Praktikum10.PlanarMechanics.Parts.FixedTranslation fixedTranslation5(r={
          wheelBase/2,0}) annotation (Placement(visible=true, transformation(
          origin={80,36},
          extent={{10,-10},{-10,10}},
          rotation=-90)));
    Praktikum10.PlanarMechanics.Joints.Revolute revolute(useFlange=true, phi(
    ...
    Praktikum10.PlanarMechanics.Parts.FixedTranslation fixedTranslation2(r={0,
          trackWidth/2}) annotation (Placement(visible=true, transformation(
          origin={46,-20},
          extent={{10,-10},{-10,10}},
          rotation=0)));
  ...
  equation
    ...
    connect(body2D.angle, driver.driving_angle_deg) annotation (Line(points={{
            74.2,8.2},{98,8.2},{98,-44},{-96,-44},{-96,8.6},{-75.8,8.6}}, color=
           {0,0,127}));
...
equation
  ...
  model SteeringLimiterTest
    Praktikum10.SteeringLimiter steeringLimiter
  ...
  package HybridCar3D
    model Body3D
      ...
      Modelica.Mechanics.MultiBody.Parts.Body body1(
        ...
        I_22=284.25,
        I_33=1137,
        r_0(fixed=true, start={0,0,wheelRadius}),
...
<strong>end for</strong>;
    ...
    model Chassis3D
      ...
      Modelica.Mechanics.MultiBody.Parts.BodyShape bodyShape2(
        ...
        width=0.62) annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={-74,20})));
    ...
    equation
      ...
      connect(bodyShape3.frame_a, dryFrictionWheelJoint3D2.frame_wheel)
        annotation (Line(
          ...
          color={95,95,95},
          thickness=0.5));
      connect(dryFrictionWheelJoint3D2.frame_chassis, fixedTranslation2.frame_b)
        annotation (Line(
          points={{-30,-66},{32,-66}},
          color={95,95,95},
          thickness=0.5));
      ...
      connect(bodyShape1.frame_a, dryFrictionWheelJoint3D1.frame_wheel)
        annotation (Line(
          ...
          color={95,95,95},
          thickness=0.5));
      connect(dryFrictionWheelJoint3D1.frame_chassis, fixedTranslation4.frame_b)
        annotation (Line(
          points={{-30,-26},{32,-26}},
          color={95,95,95},
          thickness=0.5));
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
    ...
    equation
      ...
      -f_long*radius = flange_a.tau;
      frame_a.t = {0,0,0};
      f =N*noEvent(Praktikum10.HybridCar3D.limitByStriple(
            vAdhesion,
            vSlide,
            mu_A,
            mu_S,
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
    ...
    model DryFrictionWheelJoint3D
      ...
      Praktikum10.HybridCar3D.PartialDryFrictionWheelJoint3D
        partialDryFrictionWheelJoint3D(
        radius=radius,
        r={1,0},
        vAdhesion=vAdhesion,
        vSlide=vSlide,

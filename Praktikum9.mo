package Praktikum9
  ...
  model Driver
    ...
    Modelica.Blocks.Interfaces.RealInput driving_angle annotation (
      Placement(transformation(extent={{-70,74},{-46,98}})));
    Modelica.Blocks.Math.Gain gain2(k = 3.14 / 180) annotation (
      Placement(transformation(extent={{-40,44},{-20,64}})));
  ...
  equation
    ...
    connect(combiTimeTable.y[2], gain2.u) annotation (
      Line(points={{-75,58},{-58,58},{-58,54},{-42,54}},          color = {0, 0, 127}));
    connect(gain2.y, feedback1.u1) annotation (
      Line(points={{-19,54},{-2.5,54},{-2.5,56},{10,56}},          color = {0, 0, 127}));
  ...
  connect(gain1.y, steering_angle) annotation (
    ...
    connect(driving_angle, feedback1.u2) annotation (Line(points={{-58,86},{-20,
            86},{-20,64},{18,64}}, color={0,0,127}));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false)),
      Diagram(coordinateSystem(preserveAspectRatio = false)));
  end Driver;
...
(will be replaced by a color editor).
        ...
        model CoordinateSystem "Visualizing an orthogonal coordinate system of three axes"
          ...
          parameter SI.Length scaledLabel = PlanarMechanics.Types.Defaults.FrameLabelHeightFraction * axisDiameter annotation (
            Dialog(group = "Axes labels", enable = axisShowLabels));
        protected
          outer .Praktikum9.PlanarMechanics.PlanarWorld planarWorld;
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
  ...
  Praktikum9.Differential differential annotation (Placement(visible=true,
          transformation(
          origin={62,30},
          extent={{-10,-10},{10,10}},
          rotation=90)));
  ...
  model Chassis2D
    ...
    Praktikum9.PlanarMechanics.VehicleComponents.Wheels.DryFrictionWheelJoint dryFrictionWheelJoint1(
      radius=wheelRadius,
      r={1,0},
      N=(carMass/4 + 19)*9.81,
      vAdhesion=0.01,
    ...
    Praktikum9.PlanarMechanics.Parts.FixedTranslation fixedTranslation1(r={0,-
          trackWidth/2}) annotation (Placement(visible=true, transformation(
          origin={48,20},
          extent={{10,-10},{-10,10}},
          rotation=0)));
    Praktikum9.PlanarMechanics.Parts.FixedTranslation fixedTranslation3(r={0,-
          trackWidth/2}) annotation (Placement(visible=true, transformation(
          origin={46,-60},
          extent={{10,-10},{-10,10}},
          rotation=0)));
    Praktikum9.PlanarMechanics.Parts.Body body1(m=19, I=0.653) annotation (
        Placement(visible=true, transformation(
          origin={-20,42},
          extent={{-8,-8},{8,8}},
          rotation=90)));
    Praktikum9.PlanarMechanics.Parts.Body body3(
      I=0.653,
      animate=true,
      enableGravity=true,
    ...
    Praktikum9.PlanarMechanics.Parts.FixedTranslation fixedTranslation5(r={
          wheelBase/2,0}) annotation (Placement(visible=true, transformation(
          origin={80,36},
          extent={{10,-10},{-10,10}},
          rotation=-90)));
    Praktikum9.PlanarMechanics.Joints.Revolute revolute(useFlange=true, phi(
          start=0))
    ...
    Praktikum9.PlanarMechanics.Parts.FixedTranslation fixedTranslation2(r={0,
          trackWidth/2}) annotation (Placement(visible=true, transformation(
          origin={46,-20},
          extent={{10,-10},{-10,10}},
          rotation=0)));
  ...
  model Body2D
    ...
    PlanarMechanics.Parts.Body body(m = 1376, I = 1137,
      ...
      Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin={8,56})));
  ...
  equation
    connect(frame, body.frame_a) annotation (
      Line(points={{-84,0},{8,0},{8,46}},          color = {0, 0, 0}));
    connect(quadraticSpeedDependentForce1.frame_b, body.frame_a) annotation (
      Line(points={{60,0},{8,0},{8,46}},          color = {95, 95, 95}, thickness = 0.5));
  ...
  equation
    ...
    connect(body2D.angle, driver.driving_angle) annotation (
      Line(points={{74.2,8.2},{98,8.2},{98,-44},{-96,-44},{-96,8.6},{-75.8,8.6}},              color = {0, 0, 127}));
    connect(torque.flange, steeringLimiter.flange_a)
      annotation (Line(points={{4,54},{12,54},{12,56},{18,56}},
                                                color={0,0,0}));
    ...
    connect(driver.steering_angle, torque.tau) annotation (Line(points={{-61.2,
            5.6},{-61.2,54},{-18,54}}, color={0,0,127}));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false)),
      Diagram(coordinateSystem(preserveAspectRatio = false)),
...
equation
  ...
  model SteeringLimiterTest
    Praktikum9.SteeringLimiter steeringLimiter

...
<strong>end for</strong>;
    ...
    equation
      ...
      connect(wheelSuspensionRight1.frame1, fixedTranslation2.frame_b)
        annotation (Line(points={{-4.2,-69.8},{13.9,-69.8},{13.9,-70},{32,-70}},
            color={0,0,0}));
      ...
      connect(dryFrictionWheelJoint3D1.frame_chassis, wheelSuspensionLeft1.frame)
        annotation (Line(
          points={{-30,-26},{-18,-26},{-18,-28},{-14,-28}},
          color={95,95,95},
          thickness=0.5));
      connect(wheelSuspensionLeft1.frame1, fixedTranslation4.frame_b)
        annotation (Line(points={{5.8,-31.8},{19.9,-31.8},{19.9,-30},{32,-30}},
            color={0,0,0}));
      ...
      connect(wheelSuspensionLeft.frame1, revolute3.frame_b) annotation (Line(
            points={{-6.2,56.2},{-3.1,56.2},{-3.1,56},{0,56}}, color={0,0,0}));
      annotation (
        Icon(coordinateSystem(preserveAspectRatio = false)),
        Diagram(coordinateSystem(preserveAspectRatio = false)));
    end Chassis3D;
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
    ...
    model WheelSuspensionRight
      ...
      Modelica.Mechanics.MultiBody.Joints.Revolute revolute3(n(displayUnit="1")=
            ...
            rotation=180,
            origin={50,-8})));
      Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation2(r={0,0,-0.35})
                       annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={72,16})));
      ...
      Modelica.Mechanics.MultiBody.Joints.Revolute revolute4(n(displayUnit="1")=
          ...
          Placement(transformation(
            ...
            rotation=180,
            origin={-24,-8})));
      Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation4(r={0,0,-0.15})
                       annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-50,-62})));
      ...
      Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic(
        ...
        s(start=sqrt(0.35^2 + 0.35^2), fixed=false),
        v(start=0),
        a(start=0)) annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={8,40})));
      Modelica.Mechanics.MultiBody.Forces.Spring spring(c=10000, s_unstretched=
      ...
      Modelica.Mechanics.MultiBody.Joints.RevolutePlanarLoopConstraint revolute2(n(
            ...
            rotation=180,
            origin={-18,-78})));
      Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation6(r={0,0,-0.15})
                       annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=90,
            origin={-50,-24})));
      Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedRotation(angle=180)
        annotation (Placement(transformation(
            extent={{-10,-10},{10,10}},
            rotation=180,
            origin={-72,-40})));

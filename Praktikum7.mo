package Praktikum7
  ...
  model Driver
    ...
    Modelica.Blocks.Math.Gain gain1(k = 0.5) annotation (
      Placement(transformation(extent = {{50, 46}, {70, 66}})));
    Modelica.Blocks.Math.Feedback feedback1 annotation (
      Placement(transformation(extent = {{10, 66}, {30, 46}})));
    Modelica.Blocks.Interfaces.RealInput driving_angle annotation (
      Placement(transformation(extent = {{-48, 72}, {-24, 96}})));
    Modelica.Blocks.Math.Gain gain2(k = 3.14 / 180) annotation (
      Placement(transformation(extent = {{-38, 44}, {-18, 64}})));
  ...
  equation
    ...
    connect(feedback1.u2, driving_angle) annotation (
      Line(points = {{20, 64}, {-4, 64}, {-4, 84}, {-36, 84}}, color = {0, 0, 127}));
    connect(combiTimeTable.y[2], gain2.u) annotation (
      Line(points = {{-75, 58}, {-58, 58}, {-58, 54}, {-40, 54}}, color = {0, 0, 127}));
    connect(gain2.y, feedback1.u1) annotation (
      Line(points = {{-17, 54}, {-2.5, 54}, {-2.5, 56}, {12, 56}}, color = {0, 0, 127}));
    connect(feedback1.y, gain1.u) annotation (
      Line(points = {{29, 56}, {48, 56}}, color = {0, 0, 127}));
    connect(gain1.y, steering_angle) annotation (
      Line(points = {{71, 56}, {88, 56}}, color = {0, 0, 127}));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false)),
      Diagram(coordinateSystem(preserveAspectRatio = false)));
  end Driver;
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
      ...
      equation
        ...
        annotation (
          ...
          Icon(coordinateSystem(extent = {{-40, -20}, {40, 20}}, preserveAspectRatio = false), graphics = {Line(points = {{-42, 24}, {-26, 24}, {-26, -24}, {-42, -24}}, color = {95, 95, 95}, thickness = 0.5), Line(points = {{42, 24}, {26, 24}, {26, -24}, {42, -24}}, color = {95, 95, 95}, thickness = 0.5), Text(extent = {{-90, 60}, {90, 30}}, lineColor = {0, 0, 255}, textString = "%name"), Rectangle(extent = {{-26, 8}, {26, -8}}, lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid)}),
          Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
<p>This package contains connectors and partial models (i.e., models that are only used to build other models) of the PlanarMechanics library.</p>
    ...
    package Joints "Planar joint models"
      ...
      equation
        ...
        annotation (
          Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-100, 40}, {-20, -40}}, lineColor = {0, 0, 0}, fillPattern = FillPattern.Solid, fillColor = {175, 175, 175}), Rectangle(extent = {{-20, -20}, {100, 20}}, lineColor = {0, 0, 0}, fillPattern = FillPattern.Solid, fillColor = {175, 175, 175}), Line(visible = useFlange, points = {{0, -90}, {0, -20}}, color = {0, 127, 0}), Text(extent = {{-140, -22}, {-104, -47}}, lineColor = {128, 128, 128}, textString = "a"), Text(extent = {{104, -22}, {140, -47}}, lineColor = {128, 128, 128}, textString = "b"), Text(extent = {{-150, 100}, {150, 60}}, textString = "%name", lineColor = {0, 0, 255}), Text(extent = {{-100, -50}, {100, -80}}, lineColor = {0, 0, 0}, textString = "r=%r"), Line(visible = useFlange, points = {{-92, -100}, {-30, -100}}), Line(visible = useFlange, points = {{-30, -80}, {-50, -100}}), Line(visible = useFlange, points = {{-50, -80}, {-70, -100}}), Line(visible = useFlange, points = {{-70, -80}, {-90, -100}})}),
          Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
<p>In &quot;Animation&quot; group, animation parameters for this model can be set, where <b>zPosition</b> represents the model&apos;s position along the z axis in 3D animation. Some of the values can be preset by an outer PlanarWorld model.</p>
      ...
      equation
        ...
        annotation (
          Icon(graphics = {Ellipse(extent = {{-80, 80}, {80, -80}}, pattern = LinePattern.None, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid), Ellipse(extent = {{-70, 70}, {70, -70}}, pattern = LinePattern.None, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Line(points = {{0, 0}, {-100, 0}}, color = {0, 0, 255}), Ellipse(extent = {{-20, 20}, {20, -20}}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, lineColor = {0, 0, 255}), Text(extent = {{-150, 120}, {150, 80}}, textString = "%name", lineColor = {0, 0, 255}), Text(extent = {{-150, -90}, {150, -120}}, lineColor = {0, 0, 0}, textString = "R=%R")}),
          Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
<p>The ground is hereby represented by the x-axis.</p>
      ...
      equation
        ...
        annotation (
          Icon(graphics = {Ellipse(extent = {{-80, 80}, {80, -80}}, pattern = LinePattern.None, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid), Ellipse(extent = {{-70, 70}, {70, -70}}, pattern = LinePattern.None, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Line(points = {{0, 0}, {-100, 0}}, color = {0, 0, 255}), Ellipse(extent = {{-20, 20}, {20, -20}}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, lineColor = {0, 0, 255}), Text(extent = {{-150, 120}, {150, 80}}, textString = "%name", lineColor = {0, 0, 255}), Line(visible = useHeatPort, points = {{-100, -100}, {-100, -80}, {0, -80}}, color = {191, 0, 0}, pattern = LinePattern.Dot), Text(extent = {{-150, -90}, {150, -120}}, lineColor = {0, 0, 0}, textString = "R=%R")}),
          Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
<p>This component defines the x, y-position and angle of the frame connectors, to which this component is attached to.</p>
      ...
      equation
        ...
        frame_a.t + frame_b.t = 0;
        annotation (
          Icon(graphics = {Polygon(points = {{96, -8}, {96, 12}, {0, -30}, {-96, 12}, {-96, -6}, {0, -50}, {96, -8}}, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid), Ellipse(extent = {{-20, -20}, {20, -60}}, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid), Ellipse(extent = {{-10, -30}, {10, -50}}, lineColor = {255, 255, 255}, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid, lineThickness = 0.5), Text(extent = {{-108, -24}, {-72, -49}}, lineColor = {128, 128, 128}, textString = "a"), Text(extent = {{72, -24}, {108, -49}}, lineColor = {128, 128, 128}, textString = "b"), Text(extent = {{-100, -70}, {100, -100}}, textString = "alpha=%alpha"), Text(extent = {{-150, 70}, {150, 30}}, textString = "%name", lineColor = {0, 0, 255})}),
          Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
<p>This component assures a static position difference <b>r</b> between two frame connectors, to which <b>frame_a</b> and <b>frame_b</b> are connected.</p>
 ...
 ");
        ...
        lossPower = -f * v;
        annotation (
          Icon(graphics = {Line(points = {{-60, 30}, {60, 30}}), Line(points = {{-60, -30}, {60, -30}}), Line(points = {{-100, 0}, {100, 0}}), Rectangle(extent = {{-60, 30}, {30, -30}}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid), Text(extent = {{-150, 80}, {150, 40}}, textString = "%name", lineColor = {0, 0, 255}), Text(extent = {{-100, -50}, {100, -80}}, lineColor = {0, 0, 0}, textString = "d=%d"), Line(visible = useHeatPort, points = {{-100, -100}, {-100, -80}, {-18, 0}}, color = {191, 0, 0}, pattern = LinePattern.Dot), Ellipse(extent = {{-90, 10}, {-70, -10}}, lineColor = {0, 0, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Ellipse(extent = {{70, 10}, {90, -10}}, lineColor = {0, 0, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid)}),
          Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
</html>"),Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{-100, 0}, {-58, 0}, {-43, -30}, {-13, 30}, {17, -30}, {47, 30}, {62, 0}, {100, 0}}, thickness = 0.5), Line(points = {{-70, -76}, {-70, 0}}, color = {128, 128, 128}), Line(points = {{70, -78}, {70, 0}}, color = {128, 128, 128}), Line(points = {{-70, -70}, {70, -70}}, color = {128, 128, 128}), Polygon(points = {{60, -67}, {70, -70}, {60, -73}, {60, -67}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Text(extent = {{-40, -66}, {40, -42}}, lineColor = {128, 128, 128}, textString = "phi_rel"), Text(extent = {{-150, 80}, {150, 40}}, textString = "%name", lineColor = {0, 0, 255})}),
...
</html>"),Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{-80, 40}, {-58, 40}, {-43, 10}, {-13, 70}, {17, 10}, {47, 70}, {62, 40}, {80, 40}}, color = {0, 0, 0}), Line(points = {{-70, -106}, {-70, -41}}, color = {128, 128, 128}), Line(points = {{70, -106}, {70, -41}}, color = {128, 128, 128}), Line(points = {{-70, -100}, {70, -100}}, color = {128, 128, 128}), Polygon(points = {{60, -97}, {70, -100}, {60, -103}, {60, -97}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Text(extent = {{-40, -96}, {40, -76}}, lineColor = {128, 128, 128}, textString = "phi_rel"), Rectangle(extent = {{-50, -10}, {40, -70}}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid), Line(points = {{-50, -70}, {54, -70}}), Line(points = {{-50, -10}, {54, -10}}), Line(points = {{40, -40}, {80, -40}}), Line(points = {{-80, -40}, {-50, -40}}), Line(points = {{-80, 40}, {-80, -40}}), Line(points = {{80, 40}, {80, -40}}), Line(points = {{-96, 0}, {-80, 0}}), Line(points = {{96, 0}, {80, 0}}), Text(extent = {{-150, 120}, {150, 80}}, textString = "%name", lineColor = {0, 0, 255}), Line(visible = useHeatPort, points = {{-100, -100}, {-100, -60}, {-40, -60}, {-20, -40}}, color = {191, 0, 0}, pattern = LinePattern.Dot)}),
...
(g=9.81 in negative y-axis). If this is not desired,
drag PlanarMechanics.PlanarWorld into the top level of your model.",
        Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Line(points = {{-100, -118}, {-100, 61}}, thickness = 0.5), Polygon(points = {{-100, 100}, {-120, 60}, {-80, 60}, {-100, 100}, {-100, 100}}, fillPattern = FillPattern.Solid), Line(points = {{-119, -100}, {59, -100}}, thickness = 0.5), Polygon(points = {{99, -100}, {59, -80}, {59, -120}, {99, -100}}, fillPattern = FillPattern.Solid), Text(extent = {{-150, 145}, {150, 105}}, textString = "%name", lineColor = {0, 0, 255}), Text(extent = {{95, -113}, {144, -162}}, textString = "%label1"), Text(extent = {{-170, 127}, {-119, 77}}, textString = "%label2"), Line(points = {{-56, 60}, {-56, -26}}, color = {0, 0, 255}), Polygon(points = {{-68, -8}, {-56, -48}, {-44, -8}, {-68, -8}}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid, lineColor = {0, 0, 255}), Line(points = {{2, 60}, {2, -26}}, color = {0, 0, 255}), Polygon(points = {{-10, -8}, {2, -48}, {14, -8}, {-10, -8}}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid, lineColor = {0, 0, 255}), Line(points = {{66, 60}, {66, -26}}, color = {0, 0, 255}), Polygon(points = {{54, -8}, {66, -48}, {78, -8}, {54, -8}}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid, lineColor = {0, 0, 255}), Text(extent = {{-80, 90}, {80, 60}}, lineColor = {0, 0, 0}, textString = "2-dim."), Text(visible = not inheritGravityFromMultiBody, extent = {{-100, -50}, {100, -80}}, lineColor = {0, 0, 0}, textString = "g=%constantGravity"), Text(visible = inheritGravityFromMultiBody, extent = {{-100, -50}, {100, -80}}, lineColor = {0, 0, 0}, textString = "g inherited from 3D")}),
        Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
<p>Package <b>Sensors</b> contains <b>ideal measurement</b> components to determine absolute and relative kinematic quantities, as well as cut-forces, cut-torques and power. All measured quantities can be provided in every desired coordinate system.</p>
    ...
    package Sources "Sources to drive 2D mechanical components"
      ...
      equation
        ...
        frame_a.t + frame_b.t = 0;
        annotation (
          Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Line(points = {{30, 0}, {30, -100}}, color = {95, 95, 95}, pattern = LinePattern.Dot), Line(points = {{-60, -100}, {30, -100}}, color = {95, 95, 95}, pattern = LinePattern.Dot), Polygon(points = {{14, 10}, {44, 10}, {44, 40}, {94, 0}, {44, -40}, {44, -10}, {14, -10}, {14, 10}}, lineColor = {0, 127, 0}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid), Polygon(points = {{-14, 10}, {-44, 10}, {-44, 40}, {-94, 0}, {-44, -40}, {-44, -10}, {-14, -10}, {-14, 10}}, lineColor = {0, 127, 0}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid), Text(extent = {{-150, 110}, {150, 70}}, textString = "%name", lineColor = {0, 0, 255}), Text(extent = {{-108, -24}, {-72, -49}}, lineColor = {128, 128, 128}, textString = "a"), Text(extent = {{72, -24}, {108, -49}}, lineColor = {128, 128, 128}, textString = "b")}),
          Documentation(info = "<html>
<p>
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
      ...
      equation
        ...
        frame_b.t + force[3] = 0;
        annotation (
          Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Line(points = {{0, 0}, {0, -100}}, color = {95, 95, 95}, pattern = LinePattern.Dot, visible = resolveInFrame == Modelica.Mechanics.MultiBody.Types.ResolveInFrameB.frame_resolve), Polygon(points = {{-100, 10}, {20, 10}, {20, 41}, {90, 0}, {20, -41}, {20, -10}, {-100, -10}, {-100, 10}}, lineColor = {0, 127, 0}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Solid), Text(extent = {{-150, 80}, {150, 40}}, fillPattern = FillPattern.Sphere, textString = "%name", lineColor = {0, 0, 255})}),
          Documentation(info = "<html>
<p>
The <b>3</b> signals of the <b>force</b> connector contain force and torque.
The first and second signal are interpreted as the x- and y-coordinates of
    ...
    package Utilities "Utility elements used across the library"
      ...
      package Blocks "Blocks to process signals"
        ...
        equation
          ...
          annotation (
            Icon(graphics = {Line(points = {{-70, -78}, {-70, 78}}, color = {192, 192, 192}), Polygon(points = {{-70, 100}, {-78, 78}, {-62, 78}, {-70, 100}}, lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid), Polygon(points = {{100, -70}, {78, -62}, {78, -78}, {100, -70}}, lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid), Line(points = {{-80, -70}, {78, -70}}, color = {192, 192, 192}), Text(extent = {{2, 6}, {74, -42}}, lineColor = {192, 192, 192}, textString = "S"), Line(points = {{-70, -70}, {-62, -70}, {-50, -66}, {-40, -58}, {-30, -40}, {-18, -12}, {-2, 22}, {10, 40}, {22, 52}, {32, 60}, {42, 64}, {56, 68}, {70, 68}})}),
            Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
</html>"),  Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Text(extent = {{-100, -98}, {100, -68}}, lineColor = {160, 160, 164}, textString = "sign(u) * u^2"), Polygon(points = {{0, 90}, {-8, 68}, {8, 68}, {0, 90}}, lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid), Line(points = {{0, 68}, {0, -80}}, color = {192, 192, 192}), Line(points = {{-90, 0}, {68, 0}}, color = {192, 192, 192}), Polygon(points = {{90, 0}, {68, 8}, {68, -8}, {90, 0}}, lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid), Line(points = {{-80, -50}, {80, 50}}, color = {95, 95, 95}), Line(points = {{0, 0}, {-2, 0}, {-16, -2}, {-34, -14}, {-54, -42}, {-64, -72}}, color = {0, 0, 127}, smooth = Smooth.Bezier), Line(points = {{0, 0}, {2, 0}, {16, 2}, {34, 14}, {56, 46}, {70, 90}}, color = {0, 0, 127}, smooth = Smooth.Bezier)}),
      ...
      package Functions "Library for the atan3 function which is double differentiable"
        ...
        algorithm
          ...
          annotation (
            ...
            Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Line(points = {{-82, -36}, {-46, -32}, {-30, -28}, {-18, -22}, {-8, -14}, {0, 0}, {8, 14}, {18, 22}, {30, 28}, {46, 32}, {82, 36}}), Line(points = {{82, -40}, {46, -44}, {30, -48}, {18, -54}, {8, -62}, {0, -76}}), Line(points = {{-82, 40}, {-46, 44}, {-30, 48}, {-18, 54}, {-8, 62}, {0, 76}}), Line(points = {{-90, 0}, {68, 0}}, color = {192, 192, 192}), Polygon(points = {{90, 0}, {68, 8}, {68, -8}, {90, 0}}, lineColor = {192, 192, 192}, fillColor = {192, 192, 192}, fillPattern = FillPattern.Solid), Text(extent = {{-90, -46}, {-18, -94}}, lineColor = {192, 192, 192}, textString = "atan3")}),
...
<p>This package provides conversion functions for various purposes.</p>
      ...
      package Icons "Icons used for library components"
        ...
        model PlanarGearContactExternalL1 "Icon for an external planar gear contact"
          annotation (
            Icon(graphics = {Polygon(points = {{38.6901, 40.9645}, {39.3284, 42.8041}, {41.9096, 46.8087}, {44.5357, 46.0609}, {44.6201, 41.2972}, {44.1935, 39.3973}, {47.0172, 38.2626}, {48.024, 39.9292}, {51.3814, 43.3096}, {53.7946, 42.0322}, {52.8868, 37.3551}, {52.0745, 35.5854}, {54.6006, 33.8884}, {55.9319, 35.3093}, {59.9188, 37.9178}, {62.0136, 36.1665}, {60.1532, 31.7803}, {58.9908, 30.2182}, {61.1088, 28.0331}, {62.7064, 29.1461}, {67.1485, 30.8687}, {68.8335, 28.7202}, {66.1018, 24.8167}, {64.64, 23.5304}, {66.2574, 20.9526}, {68.0515, 21.7092}, {72.7547, 22.4705}, {73.9562, 20.0187}, {70.4725, 16.7684}, {68.7753, 15.8141}, {69.8213, 12.9564}, {71.7336, 13.3234}, {76.4923, 13.0903}, {77.1577, 10.4422}, {73.0745, 7.9872}, {71.2159, 7.4067}, {71.6449, 4.394}, {73.5917, 4.3554}, {78.198, 3.1379}, {78.2983, 0.4094}, {73.7938, -1.143}, {71.8552, -1.3244}, {71.6485, -4.3605}, {73.5446, -4.803}, {77.7971, -6.9516}, {77.3279, -9.6414}, {72.5992, -10.2233}, {70.6652, -9.9976}, {69.8317, -12.9244}, {71.5945, -13.7515}, {75.3073, -16.7372}, {74.2892, -19.2707}, {69.5428, -18.8567}, {67.6979, -18.2339}, {66.2742, -20.9235}, {67.8265, -22.099}, {70.8374, -25.7914}, {69.3147, -28.0578}, {64.7581, -26.6661}, {63.0831, -25.6733}, {61.1313, -28.0081}, {62.4052, -29.4806}, {64.5827, -33.7184}, {62.6221, -35.6187}, {58.4544, -33.31}, {57.0223, -31.9906}, {54.6278, -33.8686}, {55.5677, -35.5738}, {56.8165, -40.1717}, {54.5037, -41.6228}, {50.9071, -38.4981}, {49.7806, -36.9098}, {47.0479, -38.2489}, {47.6128, -40.1123}, {47.8783, -44.8693}, {45.3143, -45.8079}, {42.446, -42.0036}, {41.6744, -40.2159}, {38.723, -40.9575}, {38.8881, -42.8976}, {38.1588, -47.6059}, {35.4557, -47.9909}, {33.441, -43.6734}, {33.0579, -41.7643}, {30.0168, -41.8761}, {29.775, -43.8082}, {28.0827, -48.2619}, {25.3586, -48.0765}, {24.2856, -43.4344}, {24.3078, -41.4874}, {21.3099, -40.9645}, {20.6716, -42.8041}, {18.0904, -46.8087}, {15.4643, -46.0609}, {15.3799, -41.2972}, {15.8065, -39.3973}, {12.9828, -38.2626}, {11.976, -39.9292}, {8.6186, -43.3096}, {6.2054, -42.0322}, {7.1132, -37.3551}, {7.9255, -35.5854}, {5.3994, -33.8884}, {4.0681, -35.3093}, {0.0812, -37.9178}, {-2.0136, -36.1665}, {-0.1532, -31.7803}, {1.0092, -30.2182}, {-1.1088, -28.0331}, {-2.7064, -29.1461}, {-7.1485, -30.8687}, {-8.8335, -28.7202}, {-6.1018, -24.8167}, {-4.64, -23.5304}, {-6.2574, -20.9526}, {-8.0515, -21.7092}, {-12.7547, -22.4705}, {-13.9562, -20.0187}, {-10.4725, -16.7684}, {-8.7753, -15.8141}, {-9.8213, -12.9564}, {-11.7336, -13.3234}, {-16.4923, -13.0903}, {-17.1577, -10.4422}, {-13.0745, -7.9872}, {-11.2159, -7.4067}, {-11.6449, -4.394}, {-13.5917, -4.3554}, {-18.198, -3.1379}, {-18.2983, -0.40937}, {-13.7938, 1.143}, {-11.8552, 1.3244}, {-11.6485, 4.3605}, {-13.5446, 4.803}, {-17.7971, 6.9516}, {-17.3279, 9.6414}, {-12.5992, 10.2233}, {-10.6652, 9.9976}, {-9.8317, 12.9244}, {-11.5945, 13.7515}, {-15.3073, 16.7372}, {-14.2892, 19.2707}, {-9.5428, 18.8567}, {-7.6979, 18.2339}, {-6.2742, 20.9235}, {-7.8265, 22.099}, {-10.8374, 25.7914}, {-9.3147, 28.0578}, {-4.7581, 26.6661}, {-3.0831, 25.6733}, {-1.1313, 28.0081}, {-2.4052, 29.4806}, {-4.5827, 33.7184}, {-2.6221, 35.6187}, {1.5456, 33.31}, {2.9777, 31.9906}, {5.3722, 33.8686}, {4.4323, 35.5738}, {3.1835, 40.1717}, {5.4963, 41.6228}, {9.0929, 38.4981}, {10.2194, 36.9098}, {12.9521, 38.2489}, {12.3872, 40.1123}, {12.1217, 44.8693}, {14.6857, 45.8079}, {17.554, 42.0036}, {18.3256, 40.2159}, {21.277, 40.9575}, {21.1119, 42.8976}, {21.8412, 47.6059}, {24.5443, 47.9909}, {26.559, 43.6734}, {26.9421, 41.7643}, {29.9832, 41.8761}, {30.2251, 43.8082}, {31.9173, 48.2619}, {34.6414, 48.0765}, {35.7144, 43.4344}, {35.6922, 41.4874}}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Polygon(points = {{-35.977, 22.4878}, {-34.8831, 24.6535}, {-32.9407, 26.8978}, {-31.8083, 27.739}, {-29.7455, 26.7376}, {-29.706, 25.3275}, {-30.2679, 22.413}, {-31.2931, 20.2139}, {-28.7696, 18.3875}, {-27.001, 20.0486}, {-24.4081, 21.4932}, {-23.0562, 21.8963}, {-21.4604, 20.2498}, {-21.9055, 18.9112}, {-23.4304, 16.3647}, {-25.1458, 14.6489}, {-23.3992, 12.0695}, {-21.1691, 13.0255}, {-18.2386, 13.4962}, {-16.8303, 13.4126}, {-15.8938, 11.3196}, {-16.77, 10.214}, {-19.0738, 8.3426}, {-21.2727, 7.3169}, {-20.5135, 4.2957}, {-18.091, 4.4313}, {-15.1762, 3.8713}, {-13.8815, 3.3112}, {-13.7173, 1.0241}, {-14.9188, 0.2848}, {-17.7237, -0.68579}, {-20.1408, -0.89754}, {-20.4607, -3.9962}, {-18.1379, -4.6973}, {-15.5904, -6.2205}, {-14.5653, -7.1897}, {-15.1933, -9.395}, {-16.5752, -9.6788}, {-19.5429, -9.6315}, {-21.8866, -9.0037}, {-23.2471, -11.8061}, {-21.3041, -13.2594}, {-19.4313, -15.562}, {-18.7995, -16.8233}, {-20.1439, -18.6809}, {-21.5394, -18.4749}, {-24.312, -17.4154}, {-26.2997, -16.024}, {-28.5365, -18.192}, {-27.2078, -20.2222}, {-26.2355, -23.0265}, {-26.0732, -24.4278}, {-27.9718, -25.7135}, {-29.2128, -25.0427}, {-31.4558, -23.0988}, {-32.8477, -21.1115}, {-35.6911, -22.3837}, {-35.1369, -24.7459}, {-35.1823, -27.7137}, {-35.5091, -29.086}, {-37.733, -29.6448}, {-38.6697, -28.59}, {-40.1125, -25.9962}, {-40.7408, -23.6526}, {-43.8479, -23.8756}, {-44.135, -26.2849}, {-45.1927, -29.0581}, {-45.9692, -30.2359}, {-48.25, -30.0005}, {-48.7695, -28.6889}, {-49.2382, -25.758}, {-49.027, -23.3409}, {-52.023, -22.4878}, {-53.1169, -24.6535}, {-55.0593, -26.8978}, {-56.1917, -27.739}, {-58.2545, -26.7376}, {-58.294, -25.3275}, {-57.7321, -22.413}, {-56.7069, -20.2139}, {-59.2304, -18.3875}, {-60.999, -20.0486}, {-63.5919, -21.4932}, {-64.9438, -21.8963}, {-66.5396, -20.2498}, {-66.0945, -18.9112}, {-64.5696, -16.3647}, {-62.8542, -14.6489}, {-64.6008, -12.0695}, {-66.8309, -13.0255}, {-69.7614, -13.4962}, {-71.1697, -13.4126}, {-72.1062, -11.3196}, {-71.23, -10.214}, {-68.9262, -8.3426}, {-66.7273, -7.3169}, {-67.4865, -4.2957}, {-69.909, -4.4313}, {-72.8238, -3.8713}, {-74.1185, -3.3112}, {-74.2827, -1.0241}, {-73.0812, -0.28477}, {-70.2763, 0.6858}, {-67.8592, 0.8975}, {-67.5393, 3.9962}, {-69.8621, 4.6973}, {-72.4096, 6.2205}, {-73.4347, 7.1897}, {-72.8067, 9.395}, {-71.4248, 9.6788}, {-68.4571, 9.6315}, {-66.1134, 9.0037}, {-64.7529, 11.8061}, {-66.6959, 13.2594}, {-68.5687, 15.562}, {-69.2005, 16.8233}, {-67.8561, 18.6809}, {-66.4606, 18.4749}, {-63.688, 17.4154}, {-61.7003, 16.024}, {-59.4635, 18.192}, {-60.7922, 20.2222}, {-61.7645, 23.0265}, {-61.9268, 24.4278}, {-60.0282, 25.7135}, {-58.7872, 25.0427}, {-56.5442, 23.0988}, {-55.1523, 21.1115}, {-52.3089, 22.3837}, {-52.8631, 24.7459}, {-52.8177, 27.7137}, {-52.4909, 29.086}, {-50.267, 29.6448}, {-49.3303, 28.59}, {-47.8875, 25.9962}, {-47.2592, 23.6526}, {-44.1521, 23.8756}, {-43.865, 26.2849}, {-42.8073, 29.0581}, {-42.0308, 30.2359}, {-39.75, 30.0005}, {-39.2305, 28.6889}, {-38.7618, 25.758}, {-38.973, 23.3409}}, fillColor = {255, 160, 160}, fillPattern = FillPattern.Solid, lineThickness = 0.5, pattern = LinePattern.None), Line(points = {{-100, 0}, {-44, 0}}, thickness = 1), Line(points = {{30, 0}, {100, 0}}, thickness = 1), Text(extent = {{-150, 100}, {150, 60}}, textString = "%name", lineColor = {0, 0, 255})}),
            Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
<p>
        ...
        model PlanetaryGear "Icon for planetary gears"
          annotation (
            Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-100, 100}, {80, -100}}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {255, 0, 0}), Rectangle(extent = {{-100, 100}, {68, 90}}, pattern = LinePattern.None, fillPattern = FillPattern.Solid), Rectangle(extent = {{-100, -90}, {68, -100}}, pattern = LinePattern.None, fillPattern = FillPattern.Solid), Rectangle(extent = {{68, 100}, {80, -100}}, pattern = LinePattern.None, fillPattern = FillPattern.Solid), Rectangle(extent = {{-60, 38}, {8, -38}}, fillColor = {0, 0, 255}, fillPattern = FillPattern.HorizontalCylinder, pattern = LinePattern.None), Rectangle(extent = {{-60, 88}, {8, 40}}, fillColor = {0, 127, 0}, fillPattern = FillPattern.HorizontalCylinder, pattern = LinePattern.None), Rectangle(extent = {{-60, -40}, {8, -88}}, fillColor = {0, 127, 0}, fillPattern = FillPattern.HorizontalCylinder, pattern = LinePattern.None), Rectangle(extent = {{8, 70}, {24, 60}}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {255, 255, 0}), Rectangle(extent = {{8, -60}, {24, -70}}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {255, 255, 0}), Rectangle(extent = {{44, 10}, {100, -10}}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {255, 255, 0}), Rectangle(extent = {{24, 82}, {44, -82}}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {255, 255, 0}), Rectangle(extent = {{-100, 10}, {-60, -10}}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {0, 0, 255}), Text(extent = {{-140, 140}, {140, 100}}, fillPattern = FillPattern.Sphere, fillColor = {85, 170, 255}, textString = "%name")}),
            Documentation(revisions = "<html>
<p>
<img src=\"modelica://PlanarMechanics/Resources/Images/dlr_logo.png\" alt=\"DLR logo\">
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
...
<p>
        ...
        package Parts "Icon for a package class which contains parts"
          extends Modelica.Icons.Package;
          annotation (
            Icon(graphics = {Rectangle(extent = {{-82, 22}, {0, -22}}, lineColor = {95, 95, 95}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {215, 215, 215}, radius = 10), Ellipse(extent = {{-10, 46}, {84, -48}}, lineColor = {95, 95, 95}, fillPattern = FillPattern.Sphere, fillColor = {215, 215, 215})}),
            Documentation(info = "<html>
<p>
...
<p>
        ...
        package Joints "Icon for a package class which contains joints"
          extends Modelica.Icons.Package;
          annotation (
            Icon(graphics = {Ellipse(extent = {{-4, 10}, {42, -36}}, lineColor = {95, 95, 95}, fillPattern = FillPattern.Sphere, fillColor = {95, 95, 95}), Polygon(points = {{14, 8}, {36, 0}, {62, 82}, {40, 88}, {14, 8}}, lineColor = {95, 95, 95}, fillPattern = FillPattern.Sphere, fillColor = {255, 255, 255}), Polygon(points = {{-4, -16}, {8, -34}, {-62, -82}, {-74, -64}, {-4, -16}}, lineColor = {95, 95, 95}, fillPattern = FillPattern.Sphere, fillColor = {255, 255, 255})}),
            Documentation(info = "<html>
<p>
...
<p>This package contains examples of wheels and vehicles rolling on a x,y-plane</p>
      ...
      equation
        ...
        annotation (
          Icon(graphics = {Rectangle(extent = {{-60, 50}, {40, -50}}, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Rectangle(extent = {{-48, 40}, {40, -40}}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Polygon(points = {{40, -60}, {60, -80}, {60, 80}, {40, 60}, {40, -60}}, pattern = LinePattern.None, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid), Polygon(points = {{20, -60}, {40, -80}, {-40, -80}, {-20, -60}, {20, -60}}, pattern = LinePattern.None, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid), Polygon(points = {{14, 10}, {34, -10}, {-34, -10}, {-14, 10}, {14, 10}}, pattern = LinePattern.None, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid, origin = {-30, 0}, rotation = 270), Polygon(points = {{14, 10}, {34, -10}, {-32, -10}, {-12, 10}, {14, 10}}, pattern = LinePattern.None, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid, origin = {-4, -26}, rotation = 360), Polygon(points = {{16, 10}, {36, -10}, {-32, -10}, {-12, 10}, {16, 10}}, pattern = LinePattern.None, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid, origin = {24, -2}, rotation = 90), Rectangle(extent = {{-100, 10}, {-40, -10}}, pattern = LinePattern.None, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid), Rectangle(extent = {{34, 10}, {102, -10}}, pattern = LinePattern.None, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-10, -100}, {10, -80}}, pattern = LinePattern.None, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-16, -36}, {10, -40}}, pattern = LinePattern.None, fillColor = {175, 175, 175}, fillPattern = FillPattern.Solid), Text(extent = {{-150, 120}, {150, 80}}, textString = "%name", lineColor = {0, 0, 255})}),
          Documentation(info = "<html>
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
      ...
      package Wheels "Wheel and tire models"
        ...
        equation
          ...
          annotation (
            Icon(graphics = {Rectangle(extent = {{-40, 100}, {40, -100}}, lineColor = {95, 95, 95}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {231, 231, 231}), Line(points = {{-40, 30}, {40, 30}}, color = {95, 95, 95}), Line(points = {{-40, -30}, {40, -30}}, color = {95, 95, 95}), Line(points = {{-40, 60}, {40, 60}}, color = {95, 95, 95}), Line(points = {{-40, 80}, {40, 80}}, color = {95, 95, 95}), Line(points = {{-40, 90}, {40, 90}}, color = {95, 95, 95}), Line(points = {{-40, 100}, {40, 100}}, color = {95, 95, 95}), Line(points = {{-40, -80}, {40, -80}}, color = {95, 95, 95}), Line(points = {{-40, -90}, {40, -90}}, color = {95, 95, 95}), Line(points = {{-40, -100}, {40, -100}}, color = {95, 95, 95}), Line(points = {{-40, -60}, {40, -60}}, color = {95, 95, 95}), Rectangle(extent = {{100, 10}, {40, -10}}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {231, 231, 231}), Text(extent = {{-150, -110}, {150, -140}}, lineColor = {0, 0, 0}, textString = "radius=%radius"), Text(extent = {{-150, 140}, {150, 100}}, textString = "%name", lineColor = {0, 0, 255})}),
            Documentation(info = "<html>
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
        ...
        equation
          ...
          lossPower = f * v_slip;
          annotation (
            Icon(graphics = {Rectangle(extent = {{-40, 100}, {40, -100}}, lineColor = {95, 95, 95}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {231, 231, 231}), Line(points = {{-40, 30}, {40, 30}}, color = {95, 95, 95}), Line(points = {{-40, -30}, {40, -30}}, color = {95, 95, 95}), Line(points = {{-40, 60}, {40, 60}}, color = {95, 95, 95}), Line(points = {{-40, 80}, {40, 80}}, color = {95, 95, 95}), Line(points = {{-40, 90}, {40, 90}}, color = {95, 95, 95}), Line(points = {{-40, 100}, {40, 100}}, color = {95, 95, 95}), Line(points = {{-40, -80}, {40, -80}}, color = {95, 95, 95}), Line(points = {{-40, -90}, {40, -90}}, color = {95, 95, 95}), Line(points = {{-40, -100}, {40, -100}}, color = {95, 95, 95}), Rectangle(extent = {{100, 10}, {40, -10}}, fillPattern = FillPattern.HorizontalCylinder, fillColor = {231, 231, 231}), Line(visible = useHeatPort, points = {{-100, -100}, {-100, -90}, {-30, -90}}, color = {191, 0, 0}, pattern = LinePattern.Dot, smooth = Smooth.None), Text(extent = {{-150, -40}, {150, -70}}, lineColor = {0, 0, 0}, textString = "radius=%radius"), Text(extent = {{-150, 140}, {150, 100}}, textString = "%name", lineColor = {0, 0, 255})}),
            Documentation(info = "<html>
...
</html>"),Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Ellipse(extent = {{-70, 70}, {70, -70}}, fillColor = {215, 215, 215}, fillPattern = FillPattern.Sphere), Ellipse(extent = {{-50, 50}, {50, -50}}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, pattern = LinePattern.None), Ellipse(extent = {{-10, 10}, {10, -10}}, lineColor = {0, 0, 255}, fillPattern = FillPattern.Solid)}));
      end Wheels;
      annotation (
        Documentation(info = "<html>
...
(will be replaced by a color editor).
...
</html>"),  Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-100, 30}, {20, -30}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Polygon(points = {{20, 60}, {100, 0}, {20, -60}, {20, 60}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Text(extent = {{-150, 100}, {150, 60}}, textString = "%name", lineColor = {0, 0, 255})}));
        end Arrow;
        ...
        protected
          ...
          annotation (
            Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-100, 30}, {0, -30}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Polygon(points = {{40, 60}, {100, 0}, {40, -60}, {40, 60}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Polygon(points = {{0, 60}, {60, 0}, {0, -60}, {0, 60}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Text(extent = {{-150, 100}, {150, 60}}, textString = "%name", lineColor = {0, 0, 255})}),
            Documentation(info = "<html>
<p>
...
(will be replaced by a color editor).
        ...
        model CoordinateSystem "Visualizing an orthogonal coordinate system of three axes"
          ...
          parameter SI.Length scaledLabel = PlanarMechanics.Types.Defaults.FrameLabelHeightFraction * axisDiameter annotation (
            Dialog(group = "Axes labels", enable = axisShowLabels));
        protected
          outer .Praktikum7.PlanarMechanics.PlanarWorld planarWorld;
...
</html>"),  Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Text(extent = {{-150, 100}, {150, 60}}, lineColor = {0, 0, 255}, textString = "%name"), Polygon(points = {{-50, -90}, {0, -72}, {50, -90}, {90, -70}, {26, -16}, {8, 40}, {-8, 40}, {-28, -16}, {-90, -70}, {-50, -90}}, lineColor = {255, 255, 255}, smooth = Smooth.None, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid), Line(points = {{0, -30}, {0, 40}}, color = {135, 135, 135}, thickness = 0.5), Line(points = {{0, -30}, {74, -66}}, color = {135, 135, 135}, thickness = 0.5), Line(points = {{-70, -66}, {0, -30}}, thickness = 0.5, color = {135, 135, 135}), Text(extent = {{-69, -54}, {-20, -84}}, lineColor = {135, 135, 135}, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid, textString = "x"), Polygon(points = {{-96, -80}, {-64, -72}, {-76, -58}, {-96, -80}}, lineColor = {135, 135, 135}, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid), Polygon(points = {{100, -82}, {76, -56}, {66, -72}, {100, -82}}, lineColor = {135, 135, 135}, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid), Text(extent = {{25, -54}, {74, -84}}, lineColor = {135, 135, 135}, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid, textString = "z"), Text(extent = {{10, 60}, {61, 30}}, lineColor = {135, 135, 135}, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid, textString = "y"), Polygon(points = {{-14, 22}, {14, 22}, {0, 62}, {-14, 22}}, lineColor = {135, 135, 135}, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid)}));
...
</html>"),  Icon(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Rectangle(extent = {{-100, 28}, {20, -30}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Polygon(points = {{20, 60}, {100, 0}, {20, -60}, {20, 60}}, lineColor = {128, 128, 128}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid), Text(extent = {{-150, 100}, {150, 60}}, textString = "%name", lineColor = {0, 0, 255})}));
        end Arrow;
...
<b>Developed 2010-2019 at the DLR Institute of System Dynamics and Control</b>
  ...
  Praktikum7.Differential differential annotation (
  ...
  model Chassis2D
    ...
    Praktikum7.PlanarMechanics.VehicleComponents.Wheels.DryFrictionWheelJoint dryFrictionWheelJoint1(radius = wheelRadius, r = {1, 0}, N = (carMass / 4 + 19) * 9.81, vAdhesion = 0.01, vSlide = 0.1, mu_A = 0.85, mu_S = 0.5) annotation (
    ...
    Praktikum7.PlanarMechanics.Parts.FixedTranslation fixedTranslation1(r = {0, -trackWidth / 2}) annotation (
      Placement(visible = true, transformation(origin = {48, 20}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    Praktikum7.PlanarMechanics.Parts.FixedTranslation fixedTranslation3(r = {0, -trackWidth / 2}) annotation (
      Placement(visible = true, transformation(origin = {46, -60}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    Praktikum7.PlanarMechanics.Parts.Body body1(m = 19, I = 0.653) annotation (
      Placement(visible = true, transformation(origin = {-20, 42}, extent = {{-8, -8}, {8, 8}}, rotation = 90)));
    Praktikum7.PlanarMechanics.Parts.Body body3(I = 0.653, animate = true, enableGravity = true, m = 19) annotation (
      Placement(visible = true, transformation(origin = {-20, -38}, extent = {{-8, -8}, {8, 8}}, rotation = 90)));
    ...
    Praktikum7.PlanarMechanics.Parts.FixedTranslation fixedTranslation5(r = {wheelBase / 2, 0}) annotation (
      Placement(visible = true, transformation(origin = {80, 36}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
    Praktikum7.PlanarMechanics.Joints.Revolute revolute(useFlange = true) annotation (
    ...
    PlanarMechanics.Joints.Revolute revolute1(useFlange = true) annotation (
      Placement(visible = true, transformation(extent = {{2, 50}, {22, 70}}, rotation = 0)));
    ...
    Praktikum7.PlanarMechanics.Parts.FixedTranslation fixedTranslation2(r = {0, trackWidth / 2}) annotation (
  ...
  equation
    ...
    connect(dryFrictionWheelJoint1.frame_a, body1.frame_a) annotation (
      Line(points = {{-36, 20}, {-20, 20}, {-20, 34}}));
    ...
    connect(Steering, revolute.flange_a) annotation (
      Line(points = {{70, 102}, {70, 10}, {12, 10}}));
    connect(fixedTranslation.frame_a, fixedTranslation5.frame_b) annotation (
      Line(points = {{58, 60}, {80, 60}, {80, 46}}));
    connect(dryFrictionWheelJoint.frame_a, body.frame_a) annotation (
      Line(points = {{-36, 60}, {-20, 60}, {-20, 74}}, color = {95, 95, 95}));
    ...
    connect(revolute1.flange_a, Steering) annotation (
      Line(points = {{12, 50}, {70, 50}, {70, 102}}));
    connect(revolute1.frame_a, dryFrictionWheelJoint.frame_a) annotation (
      Line(points = {{2, 60}, {-36, 60}}, color = {95, 95, 95}));
    connect(revolute1.frame_b, fixedTranslation.frame_b) annotation (
      Line(points = {{22, 60}, {38, 60}}, color = {95, 95, 95}));
    connect(revolute.frame_b, fixedTranslation1.frame_b) annotation (
      Line(points = {{22, 20}, {38, 20}}, color = {95, 95, 95}));
    connect(revolute.frame_a, dryFrictionWheelJoint1.frame_a) annotation (
      Line(points = {{2, 20}, {-36, 20}}, color = {95, 95, 95}));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false)),
      Diagram(coordinateSystem(preserveAspectRatio = false)));
  end Chassis2D;
  ...
  model Body2D
    ...
    PlanarMechanics.Parts.Body body(m = 1376, I = 1137) annotation (
      Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin = {10, 56})));
    PlanarMechanics.Sources.QuadraticSpeedDependentForce quadraticSpeedDependentForce1(F_nominal = -35.478, v_nominal = 2.7777777777778, tau_nominal = 0, w_nominal = 1) annotation (
      Placement(transformation(extent = {{80, -10}, {60, 10}})));
    ...
    PlanarMechanics.Sensors.AbsolutePosition absolutePosition(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameA.world)  annotation (
      Placement(transformation(extent = {{-14, 74}, {6, 94}})));
  ...
  equation
    ...
    connect(absolutePosition.frame_a, frame) annotation (
      Line(points = {{-14, 84}, {-80, 84}, {-80, 0}, {-84, 0}}, color = {95, 95, 95}, thickness = 0.5));
    connect(absolutePosition.r[3], angle) annotation (
      Line(points={{7,84.6667},{42,84.6667},{42,82},{82,82}},          color = {0, 0, 127}));
  connect(integrator.u, absoluteVelocity.v[1]) annotation (
      Line(points={{54,-76},{15,-76},{15,-34.6667}},   color = {0, 0, 127}));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false)),
      Diagram(coordinateSystem(preserveAspectRatio = false)));
  end Body2D;
  ...
  model HybrdiCar2D
    ...
    Modelica.Mechanics.Rotational.Components.Fixed fixed(phi0(displayUnit = "deg") = -0.4363323129985824) annotation (
      Placement(transformation(extent = {{4, 46}, {24, 66}})));
  ...
  equation
    ...
    connect(driveTrain2D.VL, chassis2D.VL) annotation (
      Line(points = {{22, 6}, {26, 6}}, color = {0, 0, 0}));
    connect(driveTrain2D.VR, chassis2D.VR) annotation (
      Line(points = {{22, 2}, {26, 2}}, color = {0, 0, 0}));
    ...
    connect(chassis2D.frame, body2D.frame) annotation (
      Line(points = {{44, 0}, {59.6, 0}}, color = {0, 0, 0}));
    connect(body2D.speed, driver.car_speed) annotation (
      Line(points = {{78.6, -3.8}, {96, -3.8}, {96, -40}, {-92, -40}, {-92, -3}, {-78.4, -3}}, color = {0, 0, 127}));
    connect(body2D.angle, driver.driving_angle) annotation (
      Line(points = {{76.2, 8.2}, {98, 8.2}, {98, -44}, {-96, -44}, {-96, 8.4}, {-73.6, 8.4}}, color = {0, 0, 127}));
    connect(chassis2D.Steering, fixed.flange) annotation (
      Line(points = {{41.4, 10}, {41.4, 68}, {14, 68}, {14, 56}}, color = {0, 0, 0}));
    annotation (
      Icon(coordinateSystem(preserveAspectRatio = false)),
      Diagram(coordinateSystem(preserveAspectRatio = false)),
      experiment(StopTime = 100, __Dymola_Algorithm = "Dassl"));
  ...
  equation
    connect(electricDrive.u, realExpression.y) annotation (
      Line(points = {{-4, 0}, {-57, 0}}, color = {0, 0, 127}));
